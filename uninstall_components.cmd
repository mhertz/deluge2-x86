...
"%programfiles(x86)%\Microsoft Visual Studio\Installer\vswhere" -products * -prerelease -legacy -nologo | findstr . || "%programfiles(x86)%\Microsoft Visual Studio\Installer\vs_installer.exe" /uninstall --q && rd /s /q "%programfiles(x86)%\Microsoft Visual Studio" 
